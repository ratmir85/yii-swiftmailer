<?php
    ...
    namespace ratmir85\swiftmailer;

    use ratmir85\swiftmailer\MailerInterface;
    use ratmir85\swiftmailer\MessageInterface;
    use ratmir85\swiftmailer\View;
    use Yii;

    /**
     * BaseMailer serves as a base class that implements the basic functions required by [[MailerInterface]].
     * @author Ratmir Kulakov <ratmir.kulakov@gmail.com>
    ...
    abstract class BaseMailer extends \CComponent implements MailerInterface
    {
         ...
         */
        public $messageClass = 'ratmir85\swiftmailer\BaseMessage';
        /**
        ...
        /**
         * @var \ratmir85\swiftmailer\View|array view instance or its array configuration.
         */
        private $_view = [];
        ...
        protected function createView(array $config)
        {
            if (!array_key_exists('class', $config)) {
                $config['class'] = 'ratmir85\swiftmailer\View';
            }
